export const nl = {
  ...
  'home.header.text': 'Le Domaine de Pipangaille, een onlangs gerenoveerde voormalige zijdewormkwekerij omgeven door een bosrijk park dat de charme van steen en authenticiteit combineert in een idyllische omgeving, biedt 4 gastenkamers, table d\'hôtes op reservering, zwembad in het seizoen, voor een magisch verblijf en een uitnodiging tot ontspanning.\n\nHet Domaine de Pipangaille ligt vlakbij de afrit van de snelweg A7, dicht bij de Nationale 7, op een uur van Lyon en Saint-Étienne, 45 minuten van Valence en met directe toegang tot de ViaRhôna, vlakbij de Via-fluvia.',
