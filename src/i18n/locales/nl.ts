export const nl = {
  ...
  'surroundings.descriptions.safari_peaugres.long.1': 'Een uitgestrekt dierenpark met zowel autoroutes als wandelparcours. Ontmoet meer dan 130 soorten op 80 hectare, loop door de kattentunnel van glas, bezoek de tropische Terre-des-minus-serre, de zeeleeuwenbaai, het duizend-schuilplaatsenhuis, de giraffenbrug en nog veel meer.',
  ...
  'surroundings.descriptions.le_relais_mailles.long.1': 'In een boomrijk park met dagschotels, pizza’s en burgers om ter plekke te eten, mee te nemen of vooraf te bestellen.',
  'surroundings.descriptions.le_relais_mailles.long.2': 'Groene setting open naar de Rhône en Ardèche-hellingen, met een vrolijke sfeer voor fietsers en gezinnen.',
  ...
  'surroundings.descriptions.la_table_des_saj.long.1': 'Seizoensmenu dat meebeweegt met de inspiratie van de chef, gebaseerd op verse producten en elegante borden.',
  'surroundings.descriptions.la_table_des_saj.long.2': 'Warme, intieme sfeer voor lunch of diner op enkele minuten van het domein.',
  ...
  'surroundings.descriptions.la_poule_noire.long.1': 'Chef Gérald Bondelu kookt favorieten als kikkerbilletjes, gebakken foie gras, gambas en verfijnde streekgerechten.',
  'surroundings.descriptions.la_poule_noire.long.2': 'Attent team en een zaal voor familie-etentjes of kleinschalige events.',
  ...
  'surroundings.descriptions.le_picotin.long.1': 'Riante, huiselijke klassiekers voor een ongecompliceerde lunchstop.',
  'surroundings.descriptions.le_picotin.long.2': 'Ontspannen ontvangst, makkelijke halte na een wandeling of rit langs de Rhône-oever.',
  ...
  'surroundings.descriptions.au_pre_du_rhone.long.1': 'Grote veranda aan het water voor groepen, met seizoenskeuken gericht op versheid.',
  'surroundings.descriptions.au_pre_du_rhone.long.2': 'Lichte, rustige sfeer om het Rhône-landschap in je op te nemen.',
  'surroundings.descriptions.cesar_pizza.short': 'Populaire pizzeria in Andance voor afhaalpizza’s en gulle recepten.',
  'surroundings.descriptions.cesar_pizza.long.1': 'Knapperige ovenpizza’s, burgers en deelplanken in een vriendelijke, vlotte setting.',
  'surroundings.descriptions.cesar_pizza.long.2': 'Ideaal voor een gezinsmaaltijd of avond met vrienden vlakbij Place du Cloître.',
  ...
  'surroundings.descriptions.la_villa_champagnere.long.1': 'Huisgemaakte seizoenskeuken (gourmetburgers, kikkerbilletjes, marktgerechten) geserveerd binnen of buiten.',
  'surroundings.descriptions.la_villa_champagnere.long.2': 'Ontvangt groepen met een zaal voor teamlunches, avonden of vriendentreffen.',
