export const counter = {
  ...
  "counter.menu.text":
    "Op het menu vind je onze topper: bruschetta's, royaal, eenvoudig en heerlijk, die we zonder aarzelen aanbevelen. Je kunt ook kiezen voor onze gemengde vleeswaren- en kaasplanken, perfect om met z'n tweeën of met vrienden te delen.\n\nOm je proeverij te begeleiden, bieden we een selectie lokale en ambachtelijke dranken: seizoensgebonden biologische vruchtensappen (appel, sinaasappel, witte perzik, aardbei, peer), limonades (naturel, gember, limoen), zorgvuldig bereide koffie en thee, en een reeks wijnen uit naburige dorpen, met name uit Saint-Désirat, met het Domaine du Mortier en het Domaine Louis Chomel. Onze lokale en biologische bieren maken dit aanbod compleet voor liefhebbers van authentieke smaken.\n\nEn voor zoete trek of een kleine pauze in de namiddag nodigen we je uit om onze Glace des Alpes-ijsjes te ontdekken, verkrijgbaar in een ruime keuze aan smaken, of onze huisgemaakte crêpes met suiker, huisgemaakte chocolade of confituur.",
};
