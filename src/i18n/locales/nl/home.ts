export const home = {
  "home.header.title": "De plek, gastenverblijf in de Drôme",
  "home.header.imageAlt":
    "Binnenpatio van het Domaine de Pipangaille omgeven door stenen muren, met schaduwrijk terras en trap die naar de kamers leidt",
  "home.header.text":
  ...
  "home.rooms.imageAlt":
    "Bed van de Marokkaanse kamer badend in natuurlijk licht met zicht op de bomen",
  "home.rooms.text":
  ...
  "home.counter.imageAlt":
    "Vleeswaren- en kaasplank met geroosterd brood, augurken en glas rosé",
  "home.counter.text":
  ...
  "home.booking.close": "Sluiten",
  "home.reviews.previous": "Vorige beoordeling",
  "home.reviews.next": "Volgende beoordeling",
  "home.gallery.close": "Galerij sluiten",
  "home.gallery.previous": "Vorige afbeelding",
  "home.gallery.next": "Volgende afbeelding",
};
