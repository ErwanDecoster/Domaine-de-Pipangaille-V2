export const it = {
  "seo.title": "Domaine de Pipangaille - Camere per Ospiti nella Valle del Rodano",
  "seo.description": "Camere per ospiti autentiche, tavola dello chef, bar e bancone in una ex casa della seta ristrutturata. Parco alberato, piscina. Vicino al percorso ciclabile ViaRhôna.",
  "seo.og.title": "Domaine de Pipangaille",
  "seo.og.description": "Camere per ospiti autentiche e tavola dello chef nella Valle del Rodano. Scopri la nostra tenuta per la tua vacanza perfetta.",
  "seo.twitter.title": "Domaine de Pipangaille",
  "seo.twitter.description": "Camere per ospiti nella Valle del Rodano con tavola dello chef e bar",
  "nav.home": "Home",
  "nav.place": "Il Luogo",
  ...
  "surroundings.descriptions.safari_peaugres.short":
    "Partite con la famiglia, il partner o gli amici alla scoperta del safari: oltre 130 specie e 1 200 animali su 80 ettari.",
  "surroundings.descriptions.safari_peaugres.long":
    "Un grande parco faunistico con due circuiti, uno in auto e uno a piedi. Incontrate più di 130 specie su 80 ettari, attraversate il recinto dei felini in un tunnel di vetro, entrate nella serra tropicale Terre des minus, scoprite la baia delle otarie, la serra delle mille tane, la passerella delle giraffe e molte altre sorprese.",
  "surroundings.descriptions.palais_ideal_du_facteur_cheval.short":
    "Un palazzo di pietra costruito a mano da un solo uomo, il postino Cheval: la storia appassionante di un progetto lungo una vita.",
  "surroundings.descriptions.palais_ideal_du_facteur_cheval.long":
    "Nel cuore di un giardino rigoglioso sorge questo palazzo di pietra costruito a mano dal postino Cheval in 93 000 ore e 33 anni. Ispirato alle cartoline consegnate, riunisce caimani, elefanti, pellicani, orsi, uccelli, giganti, fate, figure mitologiche, cascate e architetture di tutti i continenti in un'opera tanto inclassificabile quanto universale.",
  "surroundings.descriptions.acrobois_pilat.short":
    "Nel cuore del bosco ti aspettano 14 percorsi avventura per ogni livello, da vivere in famiglia, in coppia o con amici.",
  "surroundings.descriptions.acrobois_pilat.long":
    "Quattordici percorsi sugli alberi attraversano la foresta con zip line e ostacoli sempre diversi: mettetevi alla prova e cercate di completare l'ultima sfida.",
  "surroundings.descriptions.musee_de_l_alambic.short":
    "Rivivi il fascino dei distillatori ambulanti ammirando splendidi alambicchi di rame provenienti da tutta la Francia.",
  "surroundings.descriptions.musee_de_l_alambic.long":
    "Nel cuore della valle del Rodano, il Musée de l’Alambic della Distillerie Jean Gauthier a Saint-Désirat racconta la storia dei bouilleurs ambulants. Su 1 400 m², alambicchi di rame, strumenti e utensili raccolti in tutta la Francia compongono 30 quadri dedicati al patrimonio rurale.",
  "surroundings.descriptions.golf_de_saint_clair.short":
    "Tra la valle del Rodano e i monti dell'Ardèche ti attendono splendidi percorsi da golf immersi nel parco di un castello settecentesco.",
  "surroundings.descriptions.golf_de_saint_clair.long":
    "Situato nel parco di un castello del XVIII secolo, il percorso è celebre per i panorami e per i fairway ampi bordati da alberi che regalano una piacevole sensazione di spazio.",
  "surroundings.descriptions.viarhona.short":
    "Questo itinerario ciclabile unisce panorami alpini e spiagge della Camargue attraversando i vigneti simbolo della valle del Rodano e della Provenza del sud.",
  "surroundings.descriptions.viarhona.long":
    "ViaRhôna percorre 815 km dal Lago Lemano al Mediterraneo seguendo il Rodano: panorami alpini, vigneti delle Côtes du Rhône e la costa della Camargue in un unico viaggio.",
  "surroundings.descriptions.viafluvia.short":
    "Un'esperienza immersa nella natura tra i paesaggi della Loira, Alta Loira e Ardèche per un'avventura a 360°.",
  "surroundings.descriptions.viafluvia.long":
    "La Via Fluvia è un itinerario ciclabile di oltre 80 km, sicuro e ricavato da un'antica ferrovia, che attraversa Loira, Alta Loira e Ardèche tra scenari sempre diversi, accessibile a bici, pedoni e monopattini.",
  "surroundings.descriptions.musee_valrhona.short":
    "Immergiti nella Cité du Chocolat Valrhôna: percorso immersivo, degustazioni e laboratori per tutta la famiglia.",
  "surroundings.descriptions.musee_valrhona.long":
    "A Tain-l’Hermitage la Cité du Chocolat Valrhôna svela i segreti del cacao con tappe sensoriali, dimostrazioni degli chef, degustazioni e laboratori per grandi e piccoli. Incontra i pasticceri, scopri le materie prime e porta a casa idee di ricette e regali golosi.",
  "surroundings.descriptions.mongolfieres_et_cie.short":
    "Condividi un momento conviviale con un massimo di otto passeggeri per mongolfiera e prova una sensazione di libertà assoluta.",
  "surroundings.descriptions.mongolfieres_et_cie.long":
    "Sali a bordo delle mongolfiere da massimo otto posti che favoriscono il dialogo con l'equipaggio. In una navicella sicura e confortevole vivrai un momento conviviale e un senso di libertà totale.",
  "surroundings.descriptions.train_de_l_ardeche.short":
    "Salite sul treno a vapore per un viaggio unico in Ardèche e ammirate paesaggi eccezionali.",
  "surroundings.descriptions.train_de_l_ardeche.long":
    "Un'attività immancabile: salire sull'unico treno passeggeri che attraversa tutto il dipartimento dell'Ardèche.\n\nAutentiche locomotive a vapore vi portano in una natura preservata lungo un fiume selvaggio, dalle gole del Doux ai monti ardéchois, con panorami mozzafiato.",
  "surroundings.descriptions.la_fabrique_de_julien.short":
    "Riscopri l'infanzia alla Fabrique de Julien: caramelle artigianali, visite e golosità nostalgiche.",
  "surroundings.descriptions.la_fabrique_de_julien.long":
    "Rituffati nell'infanzia alla Fabrique de Julien di Bourg-Argental: caramelle artigianali senza glutine né conservanti, disponibili a Lione e Bourg-Argental.\n\nI nostri maestri confettieri lionesi creano leccalecca, caramelle, guimauves, cioccolatini e molto altro.\n\nVisita la fabbrica e il museo per scoprire il loro savoir-faire e vivi un'esperienza gourmet dai sapori di una volta.",
  "surroundings.descriptions.le_nougat_de_montsegur.short":
    "Delizie artigianali di Montségur-sur-Lauzon: nougat tradizionale senza additivi, fedele alla tradizione provenzale.",
  "surroundings.descriptions.le_nougat_de_montsegur.long":
    "Nel pittoresco villaggio di Montségur-sur-Lauzon, in Drôme provenzale, produciamo e vendiamo le nostre specialità.\n\nOgni prodotto è preparato con cura e cotto in calderoni di rame per garantire un'autentica qualità.\n\nIl nostro nougat tradizionale si distingue per la sua purezza, senza coloranti né conservanti.\n\nOgni ingrediente è selezionato con attenzione per perpetuare la tradizione del terroir provenzale.",
  "surroundings.descriptions.chateau_de_grignan.short":
    "Il castello di Grignan, gioiello storico dominante, fonde Rinascimento e classicismo e invita a un viaggio nell'art de vivre attraverso i secoli.",
  "surroundings.descriptions.chateau_de_grignan.long":
    "Dominando il borgo, il castello di Grignan unisce classicismo francese e ispirazione rinascimentale. Trasformato in dimora di piacere nel XVII secolo e residenza della marchesa de Sévigné, fu smantellato durante la Rivoluzione, ricostruito nel XX secolo e appartiene al Dipartimento della Drôme dal 1979. Classificato Monumento storico e Museo di Francia, offre un'immersione nell'art de vivre delle diverse epoche.",
  "surroundings.descriptions.labyrinthe_vegetal.short":
    "Labirinto di mais a Charmes: avventura ludica, sportiva e mentale in un ambiente preservato dal 2001.",
  "surroundings.descriptions.labyrinthe_vegetal.long":
    "Immerso in un contesto naturale protetto sulle alture di Charmes, questo labirinto di mais dal 2001 entusiasma grandi e piccoli con un'esperienza ludica, sportiva e intellettuale.",
  "surroundings.descriptions.compagnie_des_canotiers_rhone_et_saone.short":
    "Canotier solare sul Rodano: crociera gourmet, vista sui vigneti di Saint-Joseph, degustazione di vini e formule adatte anche alle bici.",
  "surroundings.descriptions.compagnie_des_canotiers_rhone_et_saone.long":
    "Imbarcati su un canotier elettro-solare per una crociera gourmet, una passeggiata o una cena sul Rodano. Degusta vini ammirando i pendii di Saint-Joseph e, a seconda della formula, porta a bordo la tua bici.",
  "surroundings.descriptions.le_chateau_d_anet.short":
    "Esplora il castello d'Anet, gioiello rinascimentale nell'Eure-et-Loir, e rivivi la storia di Enrico II e Diana di Poitiers con una visita guidata.",
  "surroundings.descriptions.le_chateau_d_anet.long":
    "Gli anfitrioni del castello d'Anet ti invitano al relax e al dialogo culturale. Segui una visita guidata di questo monumento costruito nel 1548 da Enrico II per Diana di Poitiers, scopri i suoi oggetti personali e la cappella dove riposa.",
  "surroundings.descriptions.le_relais_mailles.short":
    "Locale informale sul fiume a Laveyron, pratico per i ciclisti della ViaRhôna e le pause easy.",
  "surroundings.descriptions.le_relais_mailles.long":
    "Immerso in un parco alberato, combina piatti del giorno, pizze e burger da gustare sul posto, da asporto o su prenotazione.\n\nCornice verde aperta sul Rodano e le colline dell'Ardèche, atmosfera sorridente per ciclisti e famiglie.",
  "surroundings.descriptions.la_table_des_saj.short":
    "Bistrot creativo a Saint-Désirat con cucina curata e mood rilassato.",
  "surroundings.descriptions.la_table_des_saj.long":
    "Menu di stagione che segue l'ispirazione dello chef, basato su prodotto fresco e impiattamenti eleganti.\n\nAtmosfera calda e intima per pranzo o cena a pochi minuti dalla tenuta.",
  "surroundings.descriptions.la_poule_noire.short":
    "Classici regionali in un ristorante accogliente ad Albon con terrazza e sala curata.",
  "surroundings.descriptions.la_poule_noire.long":
    "Lo chef Gérald Bondelu prepara must come cosce di rana, foie gras scottato, gamberi e piatti raffinati del territorio.\n\nTeam attento e sala ricevimenti per pasti di famiglia o piccoli eventi.",
  "surroundings.descriptions.le_picotin.short":
    "Cucina francese tradizionale ad Andance, cornice semplice con terrazza ombreggiata o sala climatizzata.",
  "surroundings.descriptions.le_picotin.long":
    "Piatti generosi e casalinghi per una pausa pranzo senza fronzoli.\n\nAccoglienza rilassata, tappa facile dopo una passeggiata o pedalata lungo il Rodano.",
  "surroundings.descriptions.au_pre_du_rhone.short":
    "Ristorante panoramico tra Saint-Vallier e Tain-l’Hermitage con vista sulle colline dell’Ardèche.",
  "surroundings.descriptions.au_pre_du_rhone.long":
    "Ampia veranda sull’acqua per i gruppi, con cucina di stagione orientata alla freschezza.\n\nAmbiente luminoso e tranquillo per godersi il paesaggio del Rodano.",
  "surroundings.descriptions.cesar_pizza.short":
    "Pizzeria molto frequentata ad Andance per pizze d’asporto e ricette generose.",
  "surroundings.descriptions.cesar_pizza.long":
    "Pizze al forno croccanti, burger e taglieri in un clima cordiale e veloce.\n\nPerfetta per un pasto in famiglia o una serata tra amici vicino a Place du Cloître.",
  "surroundings.descriptions.la_villa_champagnere.short":
    "Bistronomia a km 0 a Saint-Rambert-d’Albon con look accogliente e terrazza.",
  "surroundings.descriptions.la_villa_champagnere.long":
    "Cucina di stagione fatta in casa (burger gourmet, cosce di rana, piatti di mercato) servita in sala o all’aperto.\n\nAccoglie i gruppi con sala dedicata per pranzi di team, serate o incontri tra amici.",
  ...
  "iframeConsent.text":
    "Questo contenuto è fornito da {serviceName}. Caricandolo, accetti i nostri termini d'uso e l'informativa sulla privacy del fornitore.",
  ...
  "generalConditions.title":
    "Condizioni generali di vendita per soggiorni in bed and breakfast",
  "generalConditions.subtitle": "Domaine de Pipangaille",
  "generalConditions.article1.title": "Articolo 1 - Durata del soggiorno",
  "generalConditions.article1.content":
    "Il cliente firmatario di questo contratto stipulato per un periodo determinato non può in alcun caso vantare alcun diritto di permanenza nei locali.",
  "generalConditions.article2.title": "Articolo 2 - Modalità di prenotazione",
  "generalConditions.article2.content1":
    "Una prenotazione diventa effettiva non appena il cliente ha inviato al proprietario una caparra del 25% del prezzo totale del soggiorno con un minimo di una notte per camera prenotata e una copia firmata del contratto prima della data indicata.",
  "generalConditions.article2.content2":
    "Il secondo esemplare del contratto deve essere conservato dal cliente.",
  "generalConditions.article2.content3":
    "I prezzi si intendono comprensivi di tutti i oneri secondo il foglio descrittivo, escluse le tasse di soggiorno.",
  "generalConditions.article3.title":
    "Articolo 3 - Codice del consumo - Diritto di recesso",
  "generalConditions.article3.content1":
    "Una prenotazione effettuata online, per telefono o per posta è una vendita a distanza. È un contratto concluso a distanza nel senso della definizione data dal Codice del consumo.",
  "generalConditions.article3.content2":
    "Siamo soggetti agli articoli L. 121-17 e seguenti del codice del consumo.",
  "generalConditions.article3.content3":
    "Desideriamo sottolineare che il diritto di recesso non esiste per i contratti di servizi di alloggio.",
  "generalConditions.article4.title":
    "Articolo 4 - Cancellazione del soggiorno da parte del cliente",
  "generalConditions.article4.content1":
    'Qualsiasi modifica è possibile solo previa autorizzazione del "Domaine de Pipangaille" e può comportare costi aggiuntivi.',
  "generalConditions.article4.content2":
    "Vi informiamo che in caso di cancellazione della prenotazione prima dell'inizio del soggiorno, sarà dovuto, a titolo di penale, un indennizzo fisso come segue:",
  "generalConditions.article4.bullet1":
    "se la cancellazione avviene più di 1 settimana prima della data di arrivo, la caparra sarà rimborsata integralmente;",
  "generalConditions.article4.bullet2":
    "se la cancellazione avviene meno di 1 settimana prima della data di arrivo, la caparra rimane di proprietà del Domaine de Pipangaille, che ha il diritto di reclamare e fatturare il saldo del prezzo del soggiorno (in conformità al contratto di prenotazione) se il soggiorno rimane vacante a seguito della cancellazione.",
  "generalConditions.article4.content3":
    "In caso di partenza anticipata durante il soggiorno: il pagamento completo del servizio prenotato è dovuto indipendentemente dal motivo.",
  "generalConditions.article5.title":
    "Articolo 5 - Assicurazione cancellazione a carico del cliente",
  "generalConditions.article5.content1":
    "Vi attiriamo l'attenzione sul fatto che nessuna assicurazione cancellazione è inclusa nelle nostre tariffe.",
  "generalConditions.article5.content2":
    "Si consiglia pertanto vivamente di sottoscriverne una.",
  "generalConditions.article6.title":
    "Articolo 6 - Cancellazione del soggiorno da parte del proprietario",
  "generalConditions.article6.content1":
    "Se prima dell'inizio del soggiorno il proprietario è costretto a cancellare la prenotazione, deve immediatamente informare il cliente con ogni mezzo.",
  "generalConditions.article6.content2":
    "Il cliente sarà allora immediatamente e integralmente rimborsato delle somme già versate.",
  "generalConditions.article7.title": "Articolo 7 - Orario di arrivo",
  "generalConditions.article7.content1":
    "L'arrivo è previsto nel pomeriggio a partire dalle 17:00 e possibile fino alle 22:00.",
  "generalConditions.article7.content2":
    "In caso di richiesta particolare o imprevista, sarà necessario contattarci telefonicamente al ",
  "generalConditions.article7.content3": " per segnalarci eventuali ritardi.",
  "generalConditions.article8.title": "Articolo 8 - Orario di partenza",
  "generalConditions.article8.content":
    "L'orario di partenza dalle camere è fissato alle 10:30 al massimo.",
  "generalConditions.article9.title":
    "Articolo 9 - Pagamento del saldo dell'alloggio",
  "generalConditions.article9.content1":
    "Il saldo del soggiorno sarà pagato un giorno prima del vostro arrivo, in conformità al vostro contratto di prenotazione.",
  "generalConditions.article9.content2":
    "Tutti gli eventuali oneri aggiuntivi, tra cui quelli relativi al servizio in tavola e alle bevande, saranno fatturati nel giorno della vostra partenza.",
  "generalConditions.article10.title": "Articolo 10 - Cambio di camere",
  "generalConditions.article10.content1":
    "Senza che il cliente possa vantare alcun indennizzo, il proprietario si riserva il diritto di cambiare la camera inizialmente prenotata dal cliente con una camera di pari o maggiore capacità.",
  "generalConditions.article10.content2":
    "In tal caso, il costo della prenotazione rimane invariato.",
  "generalConditions.article11.title": "Articolo 11 - Animali domestici",
  "generalConditions.article11.content":
    "Gli animali domestici non sono ammessi.",
  "generalConditions.article12.title":
    "Articolo 12 - Arte di vivere e utilizzo dei locali",
  "generalConditions.article12.content1":
    'Al fine di garantire la tranquillità dei locali e il comfort degli ospiti del Domaine de Pipangaille, il rispetto di un certo "arte di vivere" è richiesto da tutti.',
  "generalConditions.article12.content2":
    "In particolare, è vietato fumare all'interno.",
  "generalConditions.article12.content3":
    "Il cliente si impegna a rispettare le linee guida sul comportamento che gli verranno indicate e le presenti condizioni generali di vendita.",
  "generalConditions.article12.content4":
    "Il cliente si impegna a restituire le camere in perfette condizioni e senza danni al termine del soggiorno e a dichiarare sistematicamente e ad assumersi finanziariamente ogni danno di cui sia responsabile.",
  "generalConditions.article12.content5":
    "I costi di riparazione compreso il tempo degli interventi necessari per il ripristino dei locali saranno pagati secondo fatturazione separata e sulla base delle ricevute delle spese sostenute.",
  "generalConditions.article12.content6":
    "Si avverte gli ospiti che i minori presenti sulla proprietà sono posti sotto l'esclusiva e intera responsabilità dei loro genitori o delle persone autorizzate su di loro.",
  "generalConditions.article12.content7":
    "Il vostro soggiorno al Domaine de Pipangaille e l'utilizzo delle nostre attrezzature e strutture come la piscina, la cucina comune e il parcheggio avviene volontariamente e a vostro rischio. Domaine de Pipangaille non è responsabile di perdite, furti e/o danni o lesioni a beni e/o persone sulla proprietà, indipendentemente dalla causa.",
  "generalConditions.article13.title":
    "Articolo 13 - Modifica delle condizioni di vendita",
  "generalConditions.article13.content1":
    "Queste condizioni di vendita possono essere modificate in qualsiasi momento e senza preavviso.",
  "generalConditions.article13.content2":
    "L'accettazione e il rispetto di queste condizioni di vendita sono ritenuti acquisiti non appena viene versata la caparra.",
  "generalConditions.article14.title":
    "Articolo 14 - Legge sull'informatica e le libertà",
  "generalConditions.article14.content1":
    "In conformità alla legge n° 78-17 del 6 gennaio 1978 relativa all'informatica, ai file e alle libertà, avete il diritto di accedere e rettificare i dati che vi riguardano.",
  "generalConditions.article14.content2":
    "Ci impegniamo a non trasmettere in alcun caso le informazioni che ci avete comunicato ad altre società od organismi.",
