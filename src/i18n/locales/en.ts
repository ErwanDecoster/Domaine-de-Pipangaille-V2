export const en = {
  "seo.title": "Domaine de Pipangaille - Guest Rooms in Rhône Valley",
  "seo.description": "Authentic guest rooms, table d'hôtes, bar and counter in a renovated former silkworm farm. Wooded park, pool. Near ViaRhôna cycling route.",
  "seo.og.title": "Domaine de Pipangaille",
  "seo.og.description": "Authentic guest rooms and table d'hôtes in Rhône Valley. Discover our estate for your perfect holiday.",
  "seo.twitter.title": "Domaine de Pipangaille",
  "seo.twitter.description": "Guest rooms in Rhône Valley with table d'hôtes and bar",
  "nav.home": "Home",
  "nav.place": "The Place",
  ...
  "home.header.text":
    "Le Domaine de Pipangaille, a recently renovated former silkworm farm surrounded by a wooded park combining the charm of stone and authenticity in an idyllic setting, offers 4 guest rooms, table d'hôtes on reservation, an unheated swimming pool open in season, for a magical stay and an invitation to relax.\n\nThe Domaine de Pipangaille is located near the A7 motorway exit, close to the Nationale 7, one hour from Lyon and Saint-Étienne, 45 minutes from Valence and with direct access to the ViaRhôna, very close to the ViaFluvia.",
  "home.header.button": "Discover the Domain",
  "home.rooms.title": "Guest Rooms",
  "home.rooms.text":
    "You access the rooms by crossing the wooded park, which brings you into the inner courtyard surrounded by stones which gives it an authentic and soothing setting. Our rooms are located on the second floor accessible by a large staircase.\n\nWe offer four air-conditioned rooms with unique decor: one suite and three double rooms. The room decoration invites you to travel and serenity.",
  ...
  "counter.story.imageAlt":
    "Selection of drinks and treats served at the Counter",
  ...
  "surroundings.descriptions.safari_peaugres.short":
    "Head out with family, a partner or friends to discover the safari, home to more than 130 species and 1,200 animals across 80 hectares.",
  "surroundings.descriptions.safari_peaugres.long":
    "A vast wildlife park split between drive-through and walking trails. Meet over 130 species roaming 80 hectares, cross the big-cat enclosure through a glass tunnel, step into the Terre des minus tropical greenhouse, explore the sea lion bay, the thousand-hideouts aviary, the giraffe boardwalk and many more surprises.",
  "surroundings.descriptions.palais_ideal_du_facteur_cheval.short":
    "A stone palace hand-built by one man—the postman Cheval—and the captivating story of a lifelong project.",
  "surroundings.descriptions.palais_ideal_du_facteur_cheval.long":
    "Set inside a lush garden, this palace was built by hand by postman Cheval over 93,000 hours and 33 years. Inspired by the postcards he delivered, it brings together caimans, elephants, pelicans, bears, birds, giants, fairies, mythological figures, cascades and architectures from every continent, creating an architectural work that is as unclassifiable as it is universal.",
  "surroundings.descriptions.acrobois_pilat.short":
    "Deep in the woods, enjoy 14 adventure courses for every skill level with family, partner or friends.",
  "surroundings.descriptions.acrobois_pilat.long":
    "Fourteen treetop courses wind through the forest, offering challenges for all abilities. Tackle zip lines and varied obstacles and see if you can conquer the final circuit.",
  "surroundings.descriptions.musee_de_l_alambic.short":
    "Relive the charm and history of itinerant distillers while admiring magnificent copper stills from across France.",
  "surroundings.descriptions.musee_de_l_alambic.long":
    "In Saint-Désirat, the Musée de l’Alambic by Distillerie Jean Gauthier retraces the bygone era of bouilleurs ambulants. Across 1,400 m², copper stills, tools and utensils gathered from every corner of France create 30 tableaux celebrating rural heritage.",
  "surroundings.descriptions.golf_de_saint_clair.short":
    "Between the Rhône Valley and the Ardèche foothills, enjoy striking golf courses set in an 18th-century château estate.",
  "surroundings.descriptions.golf_de_saint_clair.long":
    "Laid out within the park of an 18th-century château, the course is famed for panoramic views and wide, tree-lined fairways that create a generous sense of space.",
  "surroundings.descriptions.viarhona.short":
    "This cycling route carries you from alpine panoramas to the Camargue beaches through the emblematic vineyards of the Rhône Valley and southern Provence.",
  "surroundings.descriptions.viarhona.long":
    "ViaRhôna stretches 815 km from Lake Geneva to the Mediterranean, following the Rhône River from alpine vistas through Côtes du Rhône vineyards all the way to the Camargue coast.",
  "surroundings.descriptions.viafluvia.short":
    "A nature-filled experience through the Loire, Haute-Loire and Ardèche landscapes for a full 360° outdoor escape.",
  "surroundings.descriptions.viafluvia.long":
    "Via Fluvia is an 80+ km secured cycling route laid out on a former railway, crossing Loire, Haute-Loire and Ardèche with varied scenery accessible to bikes, walkers, scooters and more.",
  "surroundings.descriptions.musee_valrhona.short":
    "Dive into Valrhona’s Cité du Chocolat: immersive trail, tastings and hands-on workshops for all ages.",
  "surroundings.descriptions.musee_valrhona.long":
    "In Tain-l’Hermitage, Valrhona’s Cité du Chocolat reveals the secrets of cocoa through sensory exhibits, chef demonstrations, tastings and family-friendly workshops. Meet pastry chefs, explore sourcing and leave with recipe ideas and gourmet gifts.",
  "surroundings.descriptions.mongolfieres_et_cie.short":
    "Share a friendly moment with up to eight passengers per balloon and revel in a feeling of total freedom.",
  "surroundings.descriptions.mongolfieres_et_cie.long":
    "Step aboard hot-air balloons carrying a maximum of eight guests to encourage conversation with the crew. In a secure, comfortable basket, savour a convivial experience and a pure sense of freedom.",
  "surroundings.descriptions.train_de_l_ardeche.short":
    "Board the heritage steam train for a unique Ardèche journey and soak up spectacular scenery.",
  "surroundings.descriptions.train_de_l_ardeche.long":
    "A must-do during any Ardèche stay: hop on the only passenger train that crosses the entire department.\n\nAuthentic steam locomotives carry you through preserved nature along a wild river, from the Doux gorges to the Ardèche mountains, with breathtaking views at every turn.",
  "surroundings.descriptions.la_fabrique_de_julien.short":
    "Relive childhood at La Fabrique de Julien: artisanal candy, guided tours and nostalgic gourmet delights.",
  "surroundings.descriptions.la_fabrique_de_julien.long":
    "Dive back into childhood at La Fabrique de Julien in Bourg-Argental, where gluten-free, preservative-free sweets are crafted in Lyon and Bourg-Argental.\n\nOur Lyonnais master confectioners create lollipops, caramels, marshmallows, chocolate-coated treats and many more delights.\n\nTour the factory and museum to witness their savoir-faire and enjoy a gourmet experience filled with old-fashioned flavours.",
  ...
  "surroundings.descriptions.labyrinthe_vegetal.short":
    "Corn maze in Charmes: a playful, sporty and brain-teasing adventure in a preserved setting since 2001.",
  "surroundings.descriptions.labyrinthe_vegetal.long":
    "Nestled in a protected landscape above Charmes, this corn maze has delighted young and old since 2001 with a fun, sporty and mind-bending challenge for the whole family.",
  ...
  "card.safari.description":
    "Go with family, as a couple or with friends to discover the Safari, more than 130 species and 1200 different animals, in a large park of 80 hectares.",
  "card.safari.button": "Learn more",
  "card.tag.family": "Family",
  "place.header.title": "The Place",
  "place.header.text":
    "A 180-year-old former silkworm farm, the authentic stone residence full of character and charm is lulled by the gentle swirl of the Rhône. Beyond the charm of the house, you can enjoy the park, the unheated pool and the summer pavilion for a relaxing, nature-filled interlude.\n\nWe offer the table d'hôtes, a bar service and sweet or savory treats, outdoor parking. Domaine de Pipangaille is located near the A7 motorway exit, close to Route Nationale 7, 1 hour from Lyon and Saint-Étienne, 45 minutes from Valence, with direct access to the ViaRhôna and very close to the ViaFluvia, bike routes and hiking trails.",
  "place.header.button": "Book a room",
  "place.services.title": "Dedicated spaces and services",
  "place.services.text":
    "Outdoor parking, a bike shelter, an unheated pool, the pavilion, relaxation areas by the courtyard and garden, as well as the table d’hôtes (reserved for overnight guests) and the bar.\n\nLe Comptoir de Pipangaille: for local or traveling guests, at the entrance of the estate we offer a timeless break on the covered terrace surrounded by greenery. Savory options: bruschettas, ravioli, bowls & salads, charcuterie and cheese boards… Sweet options: ice cream (15 flavors), waffles, crêpes, gourmet granola.",
  "place.events.title": "Event planning",
  "place.events.text":
    "A venue for a private event, brunch, seminar, meeting or professional gathering—contact us and we will make our dining room available with catering and beverage service.",
  ...
  "accommodations.rooms.equipments.commonWashingMachine":
    "Access to washing machine on request (paid)",
  ...
  "surroundings.safari_peaugres.gallery.image1":
    "Panoramic view of Safari de Peaugres park",
  "surroundings.palais_ideal_du_facteur_cheval.gallery.image1":
    "Facade of the Palais Idéal du Facteur Cheval",
  "surroundings.acrobois_pilat.gallery.image1":
    "Visitors on the Acrobois Pilat treetop course",
  "surroundings.musee_de_l_alambic.gallery.image1":
    "Copper stills displayed at the Musée de l'Alambic",
  "surroundings.golf_de_saint_clair.gallery.image1":
    "Fairways of the Golf de Saint-Clair estate",
  "surroundings.viarhona.gallery.image1":
    "Cyclists following the ViaRhôna path along the river",
  "surroundings.viafluvia.gallery.image1":
    "Family ride on the ViaFluvia greenway",
  "surroundings.musee_valrhona.gallery.image1":
    "Tasting workshop at Valrhona’s Cité du Chocolat",
  "surroundings.mongolfieres_et_cie.gallery.image1":
    "Hot-air balloon from Montgolfières & Cie above the valley",
  "surroundings.train_de_l_ardeche.gallery.image1":
    "Vintage locomotive of the Train de l'Ardèche",
  "surroundings.la_fabrique_de_julien.gallery.image1":
    "Shelves of sweets at La Fabrique de Julien",
  "surroundings.le_nougat_de_montsegur.gallery.image1":
    "Nougat bars from Le Nougat de Montségur",
  "surroundings.chateau_de_grignan.gallery.image1":
    "Exterior view of the Château de Grignan",
  ...
  "surroundings.la_belle_epoque.gallery.image1":
    "Dining room at La Belle Époque",
  "surroundings.la_belle_epoque.gallery.image2":
    "Outdoor service at La Belle Époque",
  ...
  "iframeConsent.text":
    "This content is provided by {serviceName}. By loading it, you accept our terms of use and the provider's privacy policy.",
  ...
  "legalNotices.editor.title": "Website Editor",
  "legalNotices.editor.addressLabel": "Address",
  ...
  "generalConditions.article1.title": "Article 1 - Duration of Stay",
  "generalConditions.article1.content":
    "The client signatory to this contract concluded for a fixed period shall in no circumstances be able to claim any right to remain on the premises.",
  "generalConditions.article2.title": "Article 2 - Reservation Formalities",
  "generalConditions.article2.content1":
    "A reservation becomes effective as soon as the client has sent to the owner a deposit of 25% of the total price of the stay with a minimum of one night per room retained and a signed copy of the contract before the date indicated.",
  "generalConditions.article2.content2":
    "The second copy of the contract should be kept by the client.",
  "generalConditions.article2.content3":
    "Prices are understood to include all charges according to the descriptive sheet, excluding the tourist tax.",
  "generalConditions.article3.title":
    "Article 3 - Consumer Code - Right of Withdrawal",
  "generalConditions.article3.content1":
    "A reservation made online, by phone, and/or by mail is a distance sale. It is a contract concluded at a distance within the meaning of the definition given by the Consumer Code.",
  ...
  "generalConditions.article3.content3":
    "We would like to point out that the right of withdrawal does not exist for accommodation service contracts.",
  "generalConditions.article4.title":
    "Article 4 - Cancellation of Stay by Client",
  "generalConditions.article4.content1":
    'Any modification is only possible with the agreement of "Domaine de Pipangaille" and may incur additional costs.',
  "generalConditions.article4.content2":
    "We inform you that in case of cancellation of the reservation before the start of the stay, there will be due, as a penalty clause by the client, compensation fixed as follows:",
  ...
  "generalConditions.article4.bullet2":
    "if the cancellation occurs less than 1 week before the arrival date, the deposit will remain the property of Domaine de Pipangaille, which is entitled to claim and invoice the balance of the stay price (in accordance with the reservation contract) if the stay remains vacant following the cancellation.",
  "generalConditions.article4.content3":
    "In case of early departure during the stay: full payment of the reserved service is due regardless of the reason.",
  "generalConditions.article5.title":
    "Article 5 - Cancellation Insurance at Client's Expense",
  ...
  "generalConditions.article5.content2":
    "It is therefore highly recommended that you take out such insurance.",
  "generalConditions.article6.title":
    "Article 6 - Cancellation of Stay by Owner",
  "generalConditions.article6.content1":
    "If, before the start of the stay, the owner is forced to cancel the reservation, he/she must immediately inform the client by any means.",
  ...
  "generalConditions.article9.content2":
    "Any additional fees, including those related to table service and beverages, will be invoiced on the day of your departure.",
  "generalConditions.article10.title": "Article 10 - Change of Rooms",
  "generalConditions.article10.content1":
    "Without the client being able to claim any compensation, the owner reserves the right to change the room initially reserved by the client with a room of the same or larger capacity.",
  "generalConditions.article10.content2":
    "In such case, the cost of the reservation remains unchanged.",
  "generalConditions.article11.title": "Article 11 - Pets",
  "generalConditions.article11.content": "Pets are not permitted.",
  "generalConditions.article12.title":
    "Article 12 - Art of Living and Use of Premises",
  "generalConditions.article12.content1":
    'To ensure the tranquility of the premises and the comfort of guests at Domaine de Pipangaille, respect for a certain "art of living" is required from all.',
  "generalConditions.article12.content2":
    "In particular, smoking is not permitted indoors.",
  "generalConditions.article12.content3":
    "The client undertakes to respect the etiquette guidelines that will be provided to him/her and the present general conditions of sale.",
  "generalConditions.article12.content4":
    "The client undertakes to return the rooms in perfect condition and free of damage at the end of the stay and to systematically declare - and assume financially - any damage for which he/she is responsible.",
  "generalConditions.article12.content5":
    "Repair costs including the time of interventions necessary to restore the premises will be settled according to separate invoicing and on the basis of receipts for expenses incurred.",
  "generalConditions.article12.content6":
    "Guests are reminded that minors present on the property are placed under the sole and entire responsibility of their parents or persons having authority over them.",
  "generalConditions.article12.content7":
    "Your stay at Domaine de Pipangaille and the use of our equipment and facilities such as the swimming pool, shared kitchen and parking area is done voluntarily and at your own risk. Domaine de Pipangaille is not responsible for loss, theft and/or damage or injuries to property and/or persons on the property, regardless of the cause.",
  "generalConditions.article13.title":
    "Article 13 - Modification of Terms of Sale",
  "generalConditions.article13.content1":
    "These conditions of sale may be modified at any time and without notice.",
  ...
  "generalConditions.article14.title":
    "Article 14 - Information Technology and Freedoms Law",
  "generalConditions.article14.content1":
    "In accordance with Law No. 78-17 of January 6, 1978 relating to information technology, files and freedoms, you have the right to access and correct data concerning you.",
  "generalConditions.article14.content2":
    "We undertake not to transmit the information you have communicated to us to any other companies or organizations.",
