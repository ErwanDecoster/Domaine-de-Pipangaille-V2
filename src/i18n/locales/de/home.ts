export const home = {
  "home.header.title": "Der Ort, Gästehaus in der Drôme",
  "home.header.imageAlt":
    "Innenhof des Domaine de Pipangaille umgeben von Steinmauern, mit schattiger Terrasse und Treppe zu den Zimmern",
  "home.header.text":
  ...
  "home.rooms.imageAlt":
    "Bett des Marokkanischen Zimmers in natürlichem Licht mit Blick auf die Bäume",
  "home.rooms.text":
  ...
  "home.counter.imageAlt":
    "Wurst- und Käseplatte begleitet von geröstetem Brot, Gewürzgurken und Glas Rosé",
  "home.counter.text":
  ...
  "home.booking.selectDates": "Daten auswählen",
  "home.booking.adults": "Erwachsene",
  "home.booking.children": "Kinder",
  "home.booking.close": "Schließen",
  "home.reviews.previous": "Vorherige Bewertung",
  "home.reviews.next": "Nächste Bewertung",
  "home.gallery.close": "Galerie schließen",
  "home.gallery.previous": "Vorheriges Bild",
  "home.gallery.next": "Nächstes Bild",
};
