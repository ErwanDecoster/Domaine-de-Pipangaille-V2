...
export const place = {
  "place.header.title": "Der Ort, Gästehaus in der Drôme",
  "place.header.imageAlt":
    "Außenpool umgeben von Sonnenliegen und Vegetation mit Holzpavillon in der Nähe",
  "place.header.text":
  ...
  "place.events.gallery.image2Alt":
    "Pavillon nahe dem Pool mit großem Tisch und Loungebereich beleuchtet durch Lichterketten",
  "place.events.gallery.image3Alt":
    "Überdachter Unterstand für eine Hochzeit dekoriert mit Blumensträußen im Sonnenlicht",
  "place.events.text":
