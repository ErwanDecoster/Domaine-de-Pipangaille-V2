export const fr = {
  ...
  'accommodations.hero.text': 'Vous accédez aux chambres en traversant le parc arboré, qui vous amène dans la cour intérieure entourée de pierres, ce qui lui confère un cadre authentique et apaisant.\n\nVous trouverez ensuite une cuisine d’été à votre disposition ainsi qu’une salle de convivialité. Les quatre chambres à la décoration atypique, vous invitant au voyage, sont situées au deuxième étage.',
