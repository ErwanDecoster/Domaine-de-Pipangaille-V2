export const fr = {
  ...
  'accommodations.rooms.marocaine.description': 'Une atmosphère chaleureuse inspirée des riads, des matières naturelles et suffisamment d’espace pour accueillir les familles en quête d’évasion. Cette chambre peut accueillir un couple avec un enfant.',
  'accommodations.rooms.marocaine.longDescription': "L'ambiance marocaine aux couleurs chaleureuses vous dépaysera dans cette chambre, adaptée pour 2 adultes et un enfant ou pour un séjour en amoureux. Vue sur jardin et côté cour, elle dispose d'un lit de 1,80 m * 2 m, modulable en deux lits simples, d'un grand canapé (modulable en un lit enfant), d'une double vasque, d'une grande douche italienne en tadelakt, toilettes séparés, rangement. La climatisation assure un confort optimal en été.",
